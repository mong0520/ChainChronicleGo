...
func (q *quest) StartQeust(u *clients.User)(resp map[string]interface{}, res int){
    requestUrl := GetEndpoint(API_ENTRY)
...
func (q *quest) EndQeust(u *clients.User)(resp map[string]interface{}, res int){
    requestUrl := GetEndpoint(API_RESULT)
    //fmt.Println(requestUrl)
...
func GetEndpoint(api string)(endpoint string){
